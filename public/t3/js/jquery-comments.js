$(document).ready(function(){
    ...
    //For Replies
    (function(){
        $(".comment-rply-btn").click(function(){
            $(".replies").css("display","block");
            $(this).css("display","none");
            $(".rply-close-btn").css("display","block");
        });
        
        $(".rply-close-btn").click(function(){
            $(".replies").css("display","none");
            $(this).css("display","none");
            $(".comment-rply-btn").css("display","block");
        });
        
        $("#reply").focus(function(){
            $(this).attr("disabled","disabled");
            $(".reply-login-note").html("You must be logged-in to reply!");
        });
    })();
